  ...
  <body >
    ...
    <div class="srch">
      <form class="navbar-form" action="" method="post" name="form1">
                 <input id="text1" class="form-control" type="text" name="search" placeholder="search books.." required="" style="width:500px;">
          ...
          <!-------------------------Request Book------------------------>
            ...
            <form class="navbar-form" action="" method="post" name="form1">
                       <input id="text2" class="form-control" type="text" name="bid" placeholder="Enter Book ID" required="" style="width:500px;">
    ...
    // Table haeder
         ...
         if(isset($_POST['submit1']))
         {
           if(isset($_SESSION['login_user']))
           {
             ...
             ?>
                 <script type="text/javascript">
                     alert("you need to login first to request for a book!");
                 </script>
             <?php
